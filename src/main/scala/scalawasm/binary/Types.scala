...
case class uint(size: Int, value: Int) {
...
object Alias {
  ...
  def varuint1(value: Int): varuint = varuint(1, value)
  def varuint7(value: Int): varuint = varuint(7, value)
  def varuint32(value: Int): varuint = varuint(32, value)

  def varint7(value: Int): varint = varint(7, value)
  def varint32(value: Int): varint = varint(32, value)
  def varint64(value: Int): varint = varint(64, value)

  def uint8(value: Int): uint = uint(8, value)
  def uint16(value: Int): uint = uint(16, value)
...
final case class resizable_limits(initial: Int, maximum: Option[Int] = None) extends BinaryEncoding {
  ...
  override def toBinary = {
    val flags = if (maximum.isDefined) 1 else 0
